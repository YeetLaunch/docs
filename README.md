...
| [YeetAMM Routing & Integration Guide](docs/YEETAMM_ROUTING_INTEGRATION.md) | For external aggregators/routers: pool-state layout, real+virtual reserve pricing, the decay formula, sell-cap modeling, and reference quoters. |
